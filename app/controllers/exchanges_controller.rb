class ExchangesController < ApplicationController
  ...
  def update
    respond_to do |format|
      if @exchange.update(exchange_params)
        format.html { redirect_to @exchange, notice: "Exchange was successfully updated.", status: :see_other }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to exchanges_path, notice: "Exchange was successfully destroyed.", status: :see_other }
  ...
  private
    ...
    def exchange_params
      params.expect(exchange: [ :code, :name, :metadata ])
    end
end
