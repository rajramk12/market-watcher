...
class MetricsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create metric" do
    assert_difference("Metric.count") do
      post metrics_url, params: { metric: { date: @metric.date, fundamentals: @metric.fundamentals, mcap: @metric.mcap, pb: @metric.pb, pe: @metric.pe, stock_id: @metric.stock_id } }
    end
  ...
  test "should update metric" do
    patch metric_url(@metric), params: { metric: { date: @metric.date, fundamentals: @metric.fundamentals, mcap: @metric.mcap, pb: @metric.pb, pe: @metric.pe, stock_id: @metric.stock_id } }
