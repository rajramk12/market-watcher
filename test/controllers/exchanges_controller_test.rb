...
class ExchangesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exchange" do
    assert_difference("Exchange.count") do
      post exchanges_url, params: { exchange: { code: @exchange.code, metadata: @exchange.metadata, name: @exchange.name } }
    end
  ...
  test "should update exchange" do
    patch exchange_url(@exchange), params: { exchange: { code: @exchange.code, metadata: @exchange.metadata, name: @exchange.name } }
